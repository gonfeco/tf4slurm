...
##################################################################################################################
            DISTRIBUTED TENSORFLOW SERVER.
##################################################################################################################
In this example a Distributed TensorFlow server is created and executed in the typical TF way.
This example use the ServerDictionary module from the tf_for_slurm package:
...
**************************************************************************************************************************
	...
	Finally each local machine could be a "ps" or a "worker" (this is given by task_type):
		- ps (lines 44-45): if the machine is a "ps" then a parameter server is created. In this case the join method of the server
				 is invoked. This method keeps the Distributed server TF running  forever until user or queue system kills it
**************************************************************************************************************************
**************************************************************************************************************************
